...
function ArticleCard({ article, index, t, layout = "grid" }: {
  ...
  if (layout === "featured") {
    return (
      <Link
        ...
        className="w-full relative group rounded-[2rem] overflow-hidden bg-card border border-border/60 shadow-xl cursor-pointer block"
      >
        <div className="flex flex-col lg:flex-row h-full">
          {/* Image */}
          <div className="lg:w-3/5 h-[300px] lg:h-[450px] relative w-full overflow-hidden">
            <Image
              src={article.img}
              alt={article.title}
              fill
          ...
          <div className="lg:w-2/5 p-8 lg:p-12 flex flex-col justify-center bg-card">
            ...
            <div className="flex items-center justify-between mt-auto">
              ...
              <div className="w-11 h-11 rounded-full bg-primary/10 text-primary flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
                <ArrowRight size={18} />
              </div>
            </div>
          </div>
  ...
  return (
    ...
    >
      <article className="h-full flex flex-col bg-card border border-border/60 shadow-[0_4px_20px_rgba(0,0,0,0.03)] transition-all duration-300 hover:shadow-xl group relative rounded-3xl overflow-hidden cursor-pointer">
        {/* Image */}
